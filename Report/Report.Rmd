...
knitr::include_graphics(c("../corr_pos.png", "../Plots/corr_pitch.png"))
...
```{r results = 'asis'}
extract_eq(final_pitch_glm, wrap = TRUE, intercept = "beta", ital_vars = TRUE, use_coefs = TRUE, terms_per_line = 2)
```
