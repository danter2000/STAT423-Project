...
We can see that a few of our variables have multicollinearity, but not all of them.

#### Awards EDA
![Awards Creation](../Plots/award_eda.png){width=200px, height=150px}

This chart is relevant since it shows how certain awards were only created after 
