...
For batters, we began with the "Batting" data frames within the Lahman package that included recognizable rate and counting stats for each observation (player) like batting average, walks, plate appearances, and total hits for each of the four base categories. We then joined a 

For pitcher, 

In addition to the base covariates, we saw a necessity to mutate additional variables 
