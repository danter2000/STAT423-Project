...
#### Correlation Plots
![Position Players Correlation Plot](../Plots/corr_pos.png){width=150px, height=150px}

![Pitchers Correlation Plot](../Plots/corr_pitch.png){width=150px, height=150px}
...
#### Awards EDA
![Awards Creation](../Plots/award_eda.png){width=200px, height=150px}
...
#### Steroids Clustering
![Clustering with Steroids in Red](../Plots/steroids.png){width=200px, height=200px}
...
```{r fig.cap = "Position Player Confusion Matrix", out.width="30%", out.height="30%", fig.align='center'}
get_confusion_matrix(final_pos_glm, PositionPlayerHOF_df_test, "Position Players Model")
```
```{r fig.cap = "Pitchers Confusion Matrix", out.width="30%", out.height="30%", fig.align='center'}
get_confusion_matrix(final_pitch_glm, PitcherHOF_df_test, "Pitchers Model")
```
