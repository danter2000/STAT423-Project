...
mgcv::qq.gam(final_pos_glm, pch = 1, type = "response")
title(main = "Position Players QQ-Plot")
mgcv::qq.gam(final_pitch_glm, pch = 1, type = "response")
title(main = "Pitchers QQ-Plot")
```

#### Binned Residual Plot Diagnostics

```{r, echo=FALSE, warning=FALSE, out.height="40%", out.width="40%", fig.show='hold', fig.align='left'}
plot(binned_residuals(final_pos_glm))
plot(binned_residuals(final_pitch_glm))
```
