...
* Before Cy Young Award - 33.9%
* Before Gold Glove Award - 36.4%
* Before Rolaids Reliever of the Year Award – 59.6%
* Before Silver Slugger – 63.6%
...
```{r fig.cap = "Position Players Odds Ratio CI"}
or_conf_int_plot(final_pos_glm, "Position Players Model")
```

```{r fig.cap = "Pitchers Odd Ratio CI"}
...
* All: General data tydying including the joining, mutation, and filtering necessary for analysis. Developed presentation slides and report. 
* Andy: 
* Dante: Proposed research question and gathered initial datasets. Deligated tasks based on skills of team members and project needs. Awards EDA. Interpretated odd ratios, Cook's Distances, and stated impact of our results. Quality control of final report.
* Kai:
* Kobe: 
