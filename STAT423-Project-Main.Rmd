...
y_hat_train_pos <- fitted(good_glm_pos)
train_MSE_pos <- mean((PositionPlayerHOF_df$as.factor(wein) - y_hat_train_pos)^2)

y_hat_test_pos <- predict(good_glm_pos, newdata = PredictHOF_pos_df)
