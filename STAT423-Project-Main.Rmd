...
row.names(PredictHOF_pos_df) <- PredictHOF_pos_df$Player
...
row.names(PredictHOF_pitch_df) <- PredictHOF_pitch_df$Player
...
y_hat_train_pos <- predict(good_glm_pos, data = PositionPlayerHOF_df)
