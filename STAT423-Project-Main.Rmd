...
pos_corr <- get_corr_matrix(PositionPlayerHOF_df[c("all_star", "G", "Pos", "HR",
                                                   "nice_guy_awards", "Steroids",
                                                   "votedBy", "RBI", "AVG",
                                                   "most_valuable_player", "R",
                                                   "SB", "SLG")])
replayPlot(pos_corr)

pos_corr <- get_corr_matrix(PitcherHOF_df[c("W", "SO", "SV", "Steroids",
...
# ggsave(filename = "~/desktop/postcorr.png", replayPlot(pos_corr))
```
