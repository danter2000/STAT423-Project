...
>>>>>>> 20b65bcaa8e32ae1801d8eb2f95ced67e9c015bb
...
lm_pitcher_model1 <- glm(as.factor(wein) ~ IP + ERA + WHIP + BB + all_star +
                                WAR + 
                                cy_young_award + Steroids,
                         family = binomial(link = "logit"),
                         data = PitcherHOF_df)

summary(lm_pitcher_model1)

lm_pos_model1 <- glm(as.factor(wein) ~ H + HR + avg + obp + slg + all_star +
                                WAR + 
                                cy_young_award + Steroids,
                         family = binomial(link = "logit"),
                         data = PitcherHOF_df)
...
summary(glm(wein ~ all_star + (HR:Steroids + AVG:Steroids)*WAR + Pos, data = PositionPlayerHOF_df, family = "binomial"))
```
