...
y_hat_train_pos <- predict(good_glm_pos, newdata = PredictHOF_pos_df, type = "response")
y_hat_train_pos <- ifelse(y_hat_train_pos > 0.5, 1, 0)

y_hat_train_pos_nowar <- predict(good_glm_pos_nowar, newdata = PredictHOF_pos_df, type = "response")
