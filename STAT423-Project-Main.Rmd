...
bad_glm_pitch <- glm(wein ~ W + L + G + IP + ERA + all_star + WHIP + SO + SV +
                            war + Steroids + most_valuable_player + 
                            pitching_triple_crown + nice_guy_awards + 
                            all_star + Steroids:ERA + Steroids:war + 
                            Steroids:most_valuable_player + Steroids:SO +
...
y_hat_test_pitch <- predict(bad_glm_pitch, data = PredictHOF_pitch_df, type = "response")
...
final_pitch_glm <- glm(wein ~ W + L + all_star + SO + SV + Steroids +
                              rolaids_relief_man_award + votedBy,
                       family = "binomial",
                       data = PitcherHOF_df)
